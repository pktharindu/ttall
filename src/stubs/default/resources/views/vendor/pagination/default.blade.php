                    ...
                    @foreach ($element as $page => $url)
                        @if ($page == $paginator->currentPage())
                            <li aria-current="page">
                                <span class="block px-4 py-3 text-white bg-indigo-800 border border-r-0 border-gray-300">{{ $page }}</span>
                            </li>
                        @else
                            <li>
                                <a href="{{ $url }}"
                                   class="block px-4 py-3 text-indigo-800 border border-r-0 border-gray-300 hover:text-white hover:bg-indigo-800 focus:outline-none focus:shadow-outline"
