                ...
                <div class="space-x-4">
                    ...
                    @else
                        ...
                        @if (Route::has('register'))
                            <a href="{{ route('register') }}" class="font-medium text-indigo-600 hover:text-indigo-500 focus:outline-none focus:underline transition ease-in-out duration-150">{{ __('Sign Up') }}</a>
                        @endif
                    @endauth
                </div>
            @endif
            ...
            <div class="flex flex-col justify-around">
                <div class="space-y-6">
                    ...
                    <ul class="list-reset">
                        ...
                        <li class="inline px-4">
                            <a href="https://github.com/turbolinks/turbolinks" class="font-medium text-indigo-600 hover:text-indigo-500 focus:outline-none focus:underline transition ease-in-out duration-150">Turbolinks</a>
                        </li>
                        <li class="inline px-4">
